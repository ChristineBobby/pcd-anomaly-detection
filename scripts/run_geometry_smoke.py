...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-samples", type=int, default=4, help="Max samples per class.")
    parser.add_argument("--k-normal", type=int, default=32, help="PCA normal k.")
    parser.add_argument(
        "--k-curvature",
        type=int,
        nargs="+",
    ...
    parser.add_argument("--topk-ratio", type=float, default=0.05, help="Object top-k ratio.")
    parser.add_argument(
        "--distance-only",
        action="store_true",
...
def main() -> None:
    ...
    markdown_path = stage_record_dir / f"{DEFAULT_BASENAME}.md"
    csv_path = stage_record_dir / f"{DEFAULT_BASENAME}.csv"
